<script lang="ts">
	...
	let unitOfMeasure =
		/^(?:(?:\s*\s*(?:tsp|teaspoon|tbsp|tablespoon|cup|ounce|oz|each|whole|half|quarter|pint|pt|quart|qt|gallon|lbs|pounds|kg|kilogram|gram|ml|milliliter|liter|cm|centimeter|mm|milometer|in|inch|ft|foot|large|lg|sm|small|md|medium|pieces|chunks|slice|clove|can))+\s*)$/gi;
